        ...
        >
          <li v-for="movie in movieListCom" :key="movie.id" class="movieitem">
            ...
            <div class="movie-deta-list fl">
              ...
              <p class="movie-deta-item movie-pros movie-director">药品:{{movie.directorsStr}}</p>
              <p class="movie-deta-item movie-pros movie-actor">规格:{{movie.castsStr}}</p>
            </div>
            <router-link tag="div" class="movie-go fl" :to="{name:'Seat',params:{id:movie.id}}">剂量</router-link>
          </li>
        </ul>
